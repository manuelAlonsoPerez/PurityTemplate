...
if (version_compare(JVERSION, '4', 'ge')) {
  ...
  $isExpired         = ($timePublishDown < strtotime(Factory::getDate())) && $this->item->publish_down != Factory::getDbo()->getNullDate();
  $isNotPublishedYet = $timePublishUp > strtotime(Factory::getDate());
...
<div class="item-content">
  <?php if (
    $this->item->state == 0 || $timePublishUp > strtotime(Factory::getDate())
    || (($this->item->publish_down && $timePublishDown < strtotime(Factory::getDate())) && $this->item->publish_down != Factory::getDbo()->getNullDate())
  ) : ?>
    ...
    <?php if (
      $this->item->state == 0 || $timePublishUp > strtotime(Factory::getDate())
      || (($this->item->publish_down && $timePublishDown < strtotime(Factory::getDate())) && $this->item->publish_down != $this->db->getNullDate())
    ) : ?>
    </div>
  <?php endif; ?>
